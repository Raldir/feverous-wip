...
MAX_SAMPLES_TABLE = 30000 # 5000
MAX_SAMPLES_SENTENCES = 15000 # 2500 (its -1 really)
MAX_TABLE_SIZE = 50
MIN_TABLE_SIZE = 5
...
def table_claim_data():
    ...
    for i in range(len(table_ids)):
        ...
        output_query.append("INSERT INTO  ClaimAnnotationData(page, page_id, is_table, selected_id, manipulation, quick_hyperlinks, taken_flag, annotators_num, in_tabfacts1, in_tabfacts2, in_ott, skipped, skipped_by, multiple_pages) VALUES ( '{}', {}, {}, '{}', '{}', '{}', {}, {}, {}, {}, {}, {}, {}, {});\n".format(titles[i], page_ids[i], 1, table_ids[i],  generate_manipulation(), all_hyperlinks[i], 0, 0, in_tabfacts1[i], in_tabfacts2[i], in_ott[i], 0, 0, generate_multiple_pages()))
