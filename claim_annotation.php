...
<div class="menu-frame" id="my-menu-frame">
  <div class="claim-generation-specifications">
    ...
    <div class="generated-claim-div" id="generated-claim-div">
      ...
      <input type="text" class='generated-claim' id='generated-claim' size='70em' value="">
    ...
    You are free in deciding to modify the previously created claim that uses only the highlight or to create an unrelated one (that still includes information from the highlight)."></button>
      ...
      <input type="text" class='generated-claim-extended' id='generated-claim-extended' size='70em' value="">
      ...
      <input type="text" class='generated-claim-manipulation' id='generated-claim-manipulation' size='70em' value="">
...
<div id="submission-buttons">
  ...
  <button type='button' class="fa fa-flag btn btn-warning" id='generated-claim-skip'> Skip</button>
</div>
