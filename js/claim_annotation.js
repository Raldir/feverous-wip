...
function run_page(){
  ...
  function prepare_submission(){
    ...
    var main_challenge_claim = $( "#claim-annotation-challenge-selector option:selected");
    var challenge = [];
    for (var i = 0; i < main_challenge_claim.length; i++) {
      challenge.push($(main_challenge_claim[i]).text());
    }
    challenge = JSON.stringify(challenge);
    var main_challenge_extended = $( "#claim-annotation-challenge-selector-extended option:selected");
    ...
    var main_challenge_manipulation = $( "#claim-annotation-challenge-selector-manipulation option:selected");
    ...
    else if (challenge_extended == '[]' || challenge_extended == '[""]'){
      $( "#claim-annotation-challenge-selector-extended").parent().addClass('border border-danger');
    }
    else if (challenge_manipulation == '[]' || challenge_manipulation == '[""]'){
...
class Processor {
  ...
  static log_hyperlinks(element){
    ...
    times.push(times.push(new Date().getTime()));
  ...
  static reset_claim_generation_menu(){
    ...
    $( "#claim-annotation-challenge-selector").val('default');
    $( "#claim-annotation-challenge-selector").selectpicker("refresh");
    $( "#claim-annotation-challenge-selector-extended").val('default');
    $( "#claim-annotation-challenge-selector-extended").selectpicker("refresh");
    $( "#claim-annotation-challenge-selector-manipulation").val('default');
    $( "#claim-annotation-challenge-selector-manipulation").selectpicker("refresh");
