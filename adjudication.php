...
$verdict_mismatches_file = file_get_contents("annotation-service/evidence_annotation_verdict_mismatches.json");
...
$sql = "SELECT id, verdict, evidence1, evidence2, evidence3, details1, details2, details3, annotator, claim FROM CalibrationEvidence ev WHERE id = ?";
...
$verdict_mismatch = $verdict_mismatches[$current_issue];
$sql = "SELECT id, verdict, evidence1, evidence2, evidence3, details1, details2, details3, annotator FROM CalibrationEvidence ev WHERE id = ?";
$stmt= $conn->prepare($sql);
