...
if (isset($_SESSION["user"])){
  if($_SESSION['annotation_mode'] == 'evidence'){
    if ($_SESSION['finished_calibration'] == 1){
      include 'evidence_annotation.php';
    }else{
      include 'calibration_evidence_annotation.php';
    }
    echo "<!--";
  }else if ($_SESSION['annotation_mode'] == 'claim'){
    if ($_SESSION['finished_calibration'] == 1){
      include 'claim_annotation.php';
    }else{
      include 'calibration_claim_annotation.php';
    }
    echo "<!--";
  }
}
...
<div class="login-form">
    <form  method="post">
        ...
        <p> This is the annotation tool for FEVEROUS. Please enter the credentials that have been given to you. <p/>
        <div class="form-group">
            <input type="text"  id='login-id'  class="form-control" placeholder="ID" required="required">
        </div>
        <div class="form-group">
